...
public class Config {
    ...
    public static void load() {
        ...
        if (INSTANCE.language.equals(LanguageReload.NO_LANGUAGE_CODE) && !INSTANCE.fallbacks.isEmpty()) {
            INSTANCE.language = INSTANCE.fallbacks.pollFirst();
        }
        if (INSTANCE.previousLanguage.equals(LanguageReload.NO_LANGUAGE_CODE) && !INSTANCE.previousFallbacks.isEmpty()) {
